...
admin=["u21a6c9ed9087408cabab8c0bfbb28702","uc710bda247ebd0d7438d72643580ebe8"]
wait = {
    'contact':True,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
            ...
            elif ("Gy1 gn " in msg.text):
                if msg.from_ in admin:
                    if msg.toType == 2:
                        X = cl.getGroup(msg.to)
                        X.name = msg.text.replace("Gy1 gn ","")
                        ki.updateGroup(X)
                    else:
                        ki.sendText(msg.to,"It can't be used besides the group.")
            elif ("Gy2 gn " in msg.text):
                if msg.from_ in admin:
                    if msg.toType == 2:
                        X = cl.getGroup(msg.to)
                        X.name = msg.text.replace("Gy2 gn ","")
                        kk.updateGroup(X)
                    else:
                        kk.sendText(msg.to,"It can't be used besides the group.")
            elif ("Gy3 gn " in msg.text):
                if msg.from_ in admin:
                    if msg.toType == 2:
                        X = cl.getGroup(msg.to)
                        X.name = msg.text.replace("Gy3 gn ","")
                        kc.updateGroup(X)
                    else:
            ...
            elif "Gy1 kick " in msg.text:
                if msg.from_ in admin:
                    midd = msg.text.replace("Gy1 kick ","")
                    ki.kickoutFromGroup(msg.to,[midd])
            elif "Gy2 kick " in msg.text:
                if msg.from_ in admin:
                    midd = msg.text.replace("Gy2 kick ","")
                    kk.kickoutFromGroup(msg.to,[midd])
            elif "Gy3 kick " in msg.text:
                if msg.from_ in admin:
                    midd = msg.text.replace("Gy3 kick ","")
            ...
            elif "Gy1 invite " in msg.text:
                if msg.from_ in admin:
                    midd = msg.text.replace("Cv1 invite ","")
                    ki.findAndAddContactsByMid(midd)
                    ki.inviteIntoGroup(msg.to,[midd])
            elif "Gy2 invite " in msg.text:
                if msg.from_ in admin:
                    midd = msg.text.replace("Gy2 invite ","")
                    kk.findAndAddContactsByMid(midd)
                    kk.inviteIntoGroup(msg.to,[midd])
            elif "Gy3 invite " in msg.text:
                if msg.from_ in admin:
                    midd = msg.text.replace("Gy3 invite ","")
                ...
                if msg.from_ in admin:
                    ...
                    cl.sendMessage(msg)
            elif msg.text in ["Gy1"]:
                if msg.from_ in admin:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': Amid}
                    ki.sendMessage(msg)
            elif msg.text in ["Gy2"]:
                if msg.from_ in admin:
                    msg.contentType = 13
                ...
                if msg.from_ in admin:
                    ...
                    msg.text = None
                    cl.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Gy1 gift"]:
                if msg.from_ in admin:
                    msg.contentType = 9
                    msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                        'PRDTYPE': 'THEME',
                    ...
                    msg.text = None
                    ki.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Gy2 gift"]:
                if msg.from_ in admin:
                    msg.contentType = 9
                    msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                        'PRDTYPE': 'THEME',
                    ...
                    msg.text = None
                    kk.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Gy3 gift"]:
                if msg.from_ in admin:
                    msg.contentType = 9
                    msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                        'PRDTYPE': 'THEME',
            ...
            elif msg.text in ["Gy cancel","Bot cancel"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
                ...
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Gy1 ourl","Gy1 link on"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
                        X = cl.getGroup(msg.to)
                        X.preventJoinByTicket = False
                        ki.updateGroup(X)
                        if wait["lang"] == "JP":
                            ki.sendText(msg.to,"Done Gynoid")
                        else:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Gy2 ourl","Gy2 link on"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        kk.updateGroup(X)
                        if wait["lang"] == "JP":
                            kk.sendText(msg.to,"Done Gynoid")
                        else:
            ...
            elif msg.text in ["Gy3 ourl","Gy3 link on"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        kc.updateGroup(X)
                        if wait["lang"] == "JP":
                            kc.sendText(msg.to,"Done Gynoid")
                        else:
                ...
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Pr1 curl","Pr1 link off"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
            ...
            elif msg.text in ["Pr2 curl","Pr2 link off"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
                        X = kk.getGroup(msg.to)
                        X.preventJoinByTicket = True
                        ...
                        if wait["lang"] == "JP":
                            ...
                            kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Pr3 curl","Pr3 link off"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
                        X = kc.getGroup(msg.to)
                        X.preventJoinByTicket = True
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                if msg.from_ in admin:
                    cl.sendText(msg.to,mid)
            elif "Gy1 mid" == msg.text:
                if msg.from_ in admin:
                    ki.sendText(msg.to,Amid)
            elif "Gy2 mid" == msg.text:
                if msg.from_ in admin:
                    kk.sendText(msg.to,Bmid)
            elif "Gy3 mid" == msg.text:
                if msg.from_ in admin:
                    kc.sendText(msg.to,Cmid)
            ...
            elif msg.text in ["Gy1 rename "]:
                if msg.from_ in admin:
                    string = msg.text.replace("Gy1 rename ","")
                    if len(string.decode('utf-8')) <= 20:
                        profile_B = ki.getProfile()
                        profile_B.displayName = string
                        ki.updateProfile(profile_B)
                        ki.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Gy2 rename "]:
                if msg.from_ in admin:
                    string = msg.text.replace("Gy2 rename ","")
                    if len(string.decode('utf-8')) <= 20:
                ...
                if msg.from_ in admin:
                        if msg.to in wait2['readPoint']:
                            ...
                            cl.sendText(msg.to, "Orang yang Tercyduk %s\nthat's it\n\nPeople who have ignored reads\n%sIt is abnormal ♪\n\nReading point creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        else:
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        if matched_list == []:
                            kk.sendText(msg.to,"Bye Bitch")
                            kc.sendText(msg.to,"Bye Bitch")
                            return
                ...
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        ki.sendText(msg.to,"Grup ini akan di bersihkan")
                        kk.sendText(msg.to,"Grup benar benar rata")
                        kc.sendText(msg.to,"^Goodbye Everyone^")
                        targets = []
                        for g in gs.members:
                ...
                if msg.from_ in admin:
                    ...
                    if txt[1] == "on":
                        if jml <= 2000:
                            ...
                            cl.sendText(msg.to,"Jagan lebih dari 2000")
                    elif txt[1] == "off":
                        if jml <= 2000:
                            cl.sendText(msg.to, tulisan)
                        else:
                            cl.sendText(msg.to,"Jangan lebih dari 2000")
#-----------------------------------------------
                    elif "Tagall" in pesan:
                        group = cl.getGroup(msg.to)
		                        mem = [contact.mid for contact in
group.members]
		              for mm in mem:
...
#-------------Fungsi Creator Start-----------------#
                ...
                if msg.toType == 2:
                      msg.contentType = 13
                      Creatorbot = "u21a6c9ed9087408cabab8c0bfbb28702"
                      try:
                          msg.contentMetadata = {'mid': Creatorbot}
                        
                      except:
                        Creatorbot = "Error"
                      cl.sendText(msg.to, "My Creator : Dhani")
                      cl.sendMessage(msg)
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                  ...
                  while(t):
                    ...
                    t-=1
#-----------------------------------------------
            elif msg.text in ["Selamat pagi"]:
                if msg.from_ in admin:
                    ki.sendText(msg.to,"Ohayougozaimasu^^")
...
#-----------------------------------------------          
                ...
                if msg.from_ in admin:
                    ...
                    kk.sendText(msg.to,"hai, selamat datang di grup kecil kami:)")
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    ki.sendText(msg.to,"Aku disini sayang")
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    start = time.time()
                    cl.sendText(msg.to, "Tunggu sebentar sayang...")
                ...
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        for tag in wait["blacklist"]:
                            matched_list+=filter(lambda str: str == tag, gMembMids)
                        if matched_list == []:
                            cl.sendText(msg.to,"Ngga ada pengguna yang diblacklist")
                            ki.sendText(msg.to,"Ngga ada pengguna yang diblacklist")
                            kk.sendText(msg.to,"Ngga ada pengguna yang diblacklist")
                            kc.sendText(msg.to,"Ngga ada pengguna yang diblacklist")
                            return
                        for jj in matched_list:
...
if op.type == 17:
        ...
        if op.type == 15:
            if op.param2 in Bots:
                return
            ki.sendText(op.param1, "Kenapa leave?😭")
